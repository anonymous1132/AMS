...
namespace AMS.CIM.Caojin.SqlReplicationAnalysisTool.Pages
{
            ...
            : NotifyPropertyChanged
    {
        ...
        public string DpiAwareMessage
        {
            get
            {
                return string.Format(CultureInfo.InvariantCulture, "The DPI awareness of this process is [b]{0}[/b]", FirstFloor.ModernUI.ModernUIHelper.GetDpiAwareness());
            }
        }
