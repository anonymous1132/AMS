...
namespace AMSDCMDataTranslator.Models
{
    public class ChamberSetting
    {
        ...
        public static string SiffPath
        {
            get;
            set;
        } = @"App\chamber_data\siff";

        public static string SiffHistoryPath
        {
            get;
            set;
        } = @"App\chamber_data\siff_history";
        ...
        public static string FtpUri
        {
            get;
            set;
        } = "ftp://10.132.0.38/data/siff/Chamber/import/";

        public static void SetValue()
        {
            string exePath = System.Diagnostics.Process.GetCurrentProcess().MainModule.FileName;
            string configPath = exePath.Substring(0, exePath.LastIndexOf("\\") + 1) + "App\\config\\chamberconfig.xml";
