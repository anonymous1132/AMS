...
namespace AMSACEWebMonitor
{
    public class XmlHelper
    {
        ...
        public static bool UpdateTableCell(string filePath, string tableName, string referenceColName,string referenceContent ,string colName, string content)
        {
            bool flag = false;
            DataSet ds = new DataSet();
            ds.ReadXml(filePath);
            ...
            if (!(dt.Columns.Contains(colName) && dt.Columns.Contains(referenceColName)))
            {
                return flag;
            }
            ...
            {
                if (dr[referenceColName].ToString() == referenceContent)
                {
                    dr[colName] = content;
                    ds.WriteXml(filePath);
                    flag = true;
