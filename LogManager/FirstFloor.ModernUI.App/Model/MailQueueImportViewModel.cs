...
{
    public class MailQueueImportViewModel:NotifyPropertyChanged
    {
        ...
        private List<MailQueueViewModel> dG1_ItemSource = new List<MailQueueViewModel>();
        /// <summary>
        /// DG1的ItemSource属性绑定值
        /// </summary>
        public List<MailQueueViewModel> DG1_ItemSource
        {
