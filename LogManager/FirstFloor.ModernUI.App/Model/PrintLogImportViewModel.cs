...
{
    public class PrintLogImportViewModel : NotifyPropertyChanged
    {
        ...
        private List<PrintLogViewModel> dG1_ItemSource = new List<PrintLogViewModel>();
        /// <summary>
        /// DG1的ItemSource属性绑定值
        /// </summary>
        public List<PrintLogViewModel> DG1_ItemSource
        {
