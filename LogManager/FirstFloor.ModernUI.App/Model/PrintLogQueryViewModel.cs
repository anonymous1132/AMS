...
{
    public class PrintLogQueryViewModel : NotifyPropertyChanged
    {
        ...
        public int ComboTitle_SelectedIndex
        {
            ...
            set { comboTitle_SelectedIndex = value;
                if (value == 1)
                {
        ...
        private System.Collections.ObjectModel.ObservableCollection<PrintLogViewModel> dG1_ItemSource ;
        /// <summary>
        /// DG1 ItemSource属性绑定内容
        /// </summary>
        public System.Collections.ObjectModel.ObservableCollection<PrintLogViewModel> DG1_ItemSource
        {
